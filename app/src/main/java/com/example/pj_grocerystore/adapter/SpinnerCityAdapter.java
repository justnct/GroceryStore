...
public class SpinnerCityAdapter extends ArrayAdapter<City> {
    public SpinnerCityAdapter(@NonNull Context context, int resource, @NonNull List objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        City tvSelected = this.getItem(position);
        if(tvSelected != null){
    ...
    public View getDropDownView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        City textTime =  this.getItem(position);
        if(textTime != null){
